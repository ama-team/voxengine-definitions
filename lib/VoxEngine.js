...
/**
 * @callback onEstablishedCallback
 *
 * @param {Call} call1
 * @param {Call} call2
 *
 ...
 *
 * @param {AppEvents} appevent Event class (i.e. AppEvents.CallAlerting)
 * @param {eventCallback} handler Handler function. A single parameter is passed - object with event information
 */
 ...
 * @param {Call} call1
 * @param {Call} call2
 * @param {onEstablishedCallback} [onEstablishedCallback] Function to be called once call is established. Both call1
 *   and call2 are passed to this function as parameters
 */
 ...
 * @param {onEstablishedCallback} [onEstablishedCallback] Optional function that is invoked after call is established.
 *   Both calls (incoming and outgoing) are passed to this function
 */
 ...
 *
 * @param {AppEvents} appevent Event class (i.e. AppEvents.CallAlerting)
 * @param {eventCallback} handler Handler function. If not specified, all event listeners are removed
 */
 ...
 *   {@link Call.record record} method of the {@link Call} class.
 *
 * todo: VoxEngine.createRecorder is not documented
 */
